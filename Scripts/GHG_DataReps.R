...
write_csv(GHG_FCR_15_17, path = "C:/Users/ahoun/Dropbox/VT_GHG/GHG_R/Data_Output/GHG_FCR_15_17_reps")
...
write_csv(GHG_FCR_16_17, path = "C:/Users/ahoun/Dropbox/VT_GHG/GHG_R/Data_Output/GHG_FCR_16_17_reps")

# Select and export out data from 0.1 for FCR ONLY
GHG_FCR_0.1 <- GHG_FCR_15_17 %>% filter(depth==0.1)
write_csv(GHG_FCR_0.1, path = "C:/Users/ahoun/Dropbox/VT_GHG/GHG_R/Data_Output/GHG_FCR_0.1_reps")
...
write_csv(GHG_FCR_0.1_16_17, path = "C:/Users/ahounshell/OneDrive/VT/GHG/GHG_R/Data_Output/GHG_FCR_0.1_16_17_reps")
...
# Export 'cleaned' version of GHG_FCR data (removes NaN values; calculates mean between replicates; organizes by time and depth)
write_csv(GHG_BVR_0.1, path = "C:/Users/ahoun/Dropbox/VT_GHG/GHG_R/Data_Output/GHG_BVR_0.1_reps")

# Export data from BVR at 0.1 m for 2016-2017 only
GHG_BVR_0.1_16_17 <- GHG_BVR_0.1 %>% filter(datetime>=as.Date("2016-01-01"))
write_csv(GHG_BVR_0.1_16_17, path = "C:/Users/ahoun/Dropbox/VT_GHG/GHG_R/Data_Output/BVR_0.1_16_17_reps")
...
write_csv(GHG_BVR_16_17, path = "C:/Users/ahoun/Dropbox/VT_GHG/GHG_R/Data_Output/GHG_BVR_16_17_reps")
